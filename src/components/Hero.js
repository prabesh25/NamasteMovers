  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-24 max-w-6xl mx-auto px-4 text-center pb-20">
        ...
        <h2 className="sr-only">Top Movers in Kathmandu & Moving Company Nepal</h2>
        {/* Description - keyword-rich */}{" "}
        {/* <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-10"> Nepal's #1 <strong>room shifting</strong>, <strong>office shifting</strong>, <strong> residential moving</strong>, <strong>vehicle transport</strong> &amp; <strong> packing services</strong> in Kathmandu, Pokhara, Butwal &amp; across Nepal. Sajilo, safe, and affordable. </p> */}{" "}
        <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-10">
          {" "}
          Nepal's most trusted <strong>room shifting</strong>,{" "}
          <strong>office shifting</strong>, <strong> residential moving</strong>
          , <strong>vehicle transport</strong> &amp;{" "}
          <strong> packing services</strong> across Nepal. Sajilo, safe, and
          affordable.{" "}
        </p>{" "}
        {/* Buttons */}{" "}
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            {" "}
            <FaPhoneAlt className="inline-block mr-2" /> Call 24/7:
            +977-9851071848{" "}
          </a>{" "}
        </div>{" "}
        {/* Stats */}{" "}
