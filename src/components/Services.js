      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 md:mb-14 flex flex-col gap-4 md:gap-6 text-center md:text-left">
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed">
            Professional moving services for homes, offices, vehicles, and international relocations. Sajilo Packers and Movers guarantees safe handling, on-time delivery, and customer satisfaction across Kathmandu, Pokhara, Butwal &amp; all Nepal.
          </p>
        </div>
...
bg-gradient-to-r from-red-500/80  to-orange-400
