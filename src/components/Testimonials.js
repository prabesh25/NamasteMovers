...
const testimonials = [
  {
    ...
    text: "Namaste Packers and Movers handled our room shifting in Kathmandu with great care. The team arrived on time, packed everything safely, and delivered without any damage. Highly recommended for room shifting services in Nepal.",
    rating: 5,
    image: "/01Review.jpg",
  },
  {
    ...
    text: "We used Namaste Packers and Movers for office shifting from Butwal to Kathmandu. Good communication from booking to delivery. The price was fair with no hidden charges. Our IT equipment was handled very professionally.",
    rating: 5,
    image: "/02Review.jpg",
  },
  {
    ...
    text: "I needed urgent bike transport from Pokhara to Kathmandu and Namaste Packers managed it within a day. Very professional staff, secure loading, and GPS tracking throughout. Thank you for the quick and safe vehicle transport service.",
    rating: 5,
    image: "/03Review.webp",
  },
];
