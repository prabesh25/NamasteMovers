...
//   { 
//     name: "Charlotte H.", 
//     text: "All went very smoothly and easily and the courier whose bid I accepted were lovely, good communication, and helpful. Couldn't fault at all and would certainly use again.",
//     rating: 5
//   },
//   { 
//     name: "Mark W.", 
//     text: "Simple and effective, will be using regularly. Good value and makes the process of moving big things around so much easier!",
//     rating: 5
//   },
//   { 
//     name: "Sandy B.", 
//     text: "In a matter of hours, I received an offer that matched my budget from a company with very good feedback.",
//     rating: 5
//   },
// ];
...
//         <div className="absolute top-1/2 left-1/2 w-[700px] h-[400px]
...
const testimonials = [
  ...
  },
  {
    ...
    text: "We used Fast Packers and Movers for office shifting from Pokhara to Kathmandu. Good communication from booking to delivery. The price was fair with no hidden charges. Our IT equipment was handled very professionally.",
    rating: 4,
  },
  {
    name: "David P.",
    ...
    text: "I needed urgent bike transport from Butwal to Kathmandu and Fast Packers managed it within a day. Very professional staff, secure loading, and GPS tracking throughout. Thank you for the quick and safe vehicle transport service.",
    rating: 5,
  },
];
