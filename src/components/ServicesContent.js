...
const services = [
  ...
  },
  {
    name: "Packing & Boxing",
    slug: "packing-boxing",
    icon: (<svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg>),
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-5">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-[1.15]">
                Moving &amp; Packing
                <span className="block bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Services in Nepal</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-5 pt-2 text-xs text-gray-400">
                <span className="flex items-center gap-1.5"><svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg><strong className="text-gray-600">15K+</strong> Moves</span>
                <span className="flex items-center gap-1.5"><svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" /></svg><strong className="text-gray-600">12+</strong> Cities</span>
                <span className="flex items-center gap-1.5"><svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" /></svg><strong className="text-gray-600">4.9</strong> Rating</span>
                <span className="flex items-center gap-1.5"><svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg><strong className="text-gray-600">24/7</strong> Open</span>
              </div>
            </div>
            ...
            <div className="hidden md:block relative">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-3">
                  <img src="/img3.jpg" alt="Room shifting service" className="w-full h-40 object-cover rounded-2xl shadow-lg" loading="lazy" />
                  <img src="/corporateMoving.jpg" alt="Corporate moving" className="w-full h-52 object-cover rounded-2xl shadow-lg" loading="lazy" />
                </div>
                <div className="space-y-3 pt-6">
                  <img src="/ResidentialShifting.jpg" alt="Residential shifting" className="w-full h-52 object-cover rounded-2xl shadow-lg" loading="lazy" />
                  <img src="/PackingAndBoxing.jpg" alt="Packing services" className="w-full h-40 object-cover rounded-2xl shadow-lg" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-4 md:grid-cols-8 gap-2 md:gap-3">
            {services.map((s, idx) => (
              ...
              >
                <span className="text-orange-500 group-hover:text-red-500 transition">{s.icon}</span>
                <span className="text-[10px] md:text-xs font-semibold text-gray-500 group-hover:text-red-600 text-center leading-tight transition">{s.name}</span>
              </a>
            ))}
          </div>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className={`grid md:grid-cols-2 gap-10 md:gap-16 items-center ${index % 2 === 1 ? "md:[direction:rtl]" : ""}`}>
                {/* Image */}
                <div className={`relative ${index % 2 === 1 ? "md:[direction:ltr]" : ""}`}>
                  <div className={`absolute -inset-6 bg-gradient-to-br ${service.color} opacity-10 rounded-3xl blur-2xl`} />
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100 group">
                    ...
                    <div className="absolute top-5 left-5">
                      <span className={`inline-flex items-center gap-2 rounded-full bg-gradient-to-r ${service.color} px-4 py-2 text-sm font-bold text-white shadow-lg`}>
                ...
                {/* Content */}
                <div className={`space-y-6 ${index % 2 === 1 ? "md:[direction:ltr]" : ""}`}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {service.features.map((feature) => (
                      <div key={feature} className="flex items-start gap-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl px-4 py-3 border border-green-100">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-400 max-w-2xl mx-auto">
              From booking to unpacking — we make your move effortless in just 4 simple steps.
            </p>
          </div>
            ...
            {process_steps.map((item, idx) => (
              <div key={item.step} className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 text-center hover:bg-white/10 hover:border-white/20 hover:-translate-y-2 transition-all duration-300 group-hover:shadow-[0_20px_60px_-15px_rgba(239,68,68,0.2)]">
                  ...
                  <div className="text-xs font-bold text-orange-400/60 tracking-widest mb-2">STEP {item.step}</div>
      ...
      <section className="relative py-24 md:py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10">
            Whether it&apos;s room shifting, office shifting, vehicle transport, or international moving — we&apos;ve got you covered.
          </p>
