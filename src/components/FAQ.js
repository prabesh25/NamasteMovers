    ...
    () => [
      {
        ...
        a: 'Room shifting costs in Kathmandu vary based on the volume of items, distance, and floor level. Fast Packers and Movers offers affordable room shifting starting from Rs 2,000. Call +977-9851226669 for a free estimate tailored to your move.',
      },
      {
        q: 'Do you provide office shifting services in Pokhara and Butwal?',
        a: 'Yes! Fast Packers and Movers provides professional office shifting services in Pokhara, Butwal, and all major cities across Nepal. We handle IT equipment, furniture, and documents with care to ensure minimal downtime for your business.',
      },
      {
      ...
      },
      {
        ...
        a: 'Absolutely. Fast Packers and Movers offers secure vehicle and bike transport across Nepal with GPS tracking, safe carrier loading, and door-to-door delivery. We transport cars, motorcycles, and scooters between Kathmandu, Pokhara, Butwal, Biratnagar, and all cities.',
      },
      {
      ...
      {
        q: 'How fast can I book a move with Fast Packers and Movers?',
      ...
      },
      {
        ...
        a: 'Fast Packers and Movers serves all major cities in Nepal including Kathmandu, Lalitpur, Bhaktapur, Pokhara, Butwal, Biratnagar, Dharan, Chitwan, Hetauda, Janakpur, Narayanghat, Bhairahawa, Nepalgunj, and Dhangadhi.',
      },
    ],
    []
  );
              ...
              <div className="relative mx-auto w-full max-w-sm md:max-w-none">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-gray-200 bg-white/5 shadow-[0_25px_60px_-40px_rgba(0,0,0,0.08)] transform md:-rotate-2">
                  <div className="aspect-[4/5] w-full bg-black/10">
                    <img
                      src={imageSrc}
                      alt="Frequently Asked Questions about Room Shifting, Office Shifting and Moving Services in Nepal - Fast Packers and Movers"
