...
const galleryVideos = [
  ...
  },
  {
    ...
    title: "Room Shifting in Action",
    category: "Room Shifting",
  },
  {
    src: "/videos/video3.mp4",
    title: "Office Shifting & IT Equipment Handling",
    category: "Office Shifting",
  },
  {
    src: "/videos/video4.mp4",
    title: "Vehicle & Bike Transport",
    category: "Vehicle Transport",
  },
  {
    src: "/videos/video1.mp4",
    title: "Loading & Unloading Expertise",
    category: "Fleet",
  },
  {
    src: "/videos/video2.mp4",
...
export default function GalleryContent() {
  ...
  const filteredVideos =
    activeCategory === "All"
      ? galleryVideos
      : galleryVideos.filter((v) => v.category === activeCategory);

  /* ─── Lightbox Navigation ─── */
  const currentItems =
    lightboxType === "photo" ? filteredImages : filteredVideos;
      ...
      <section className="relative overflow-hidden" style={{ height: "70dvh" }}>
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-16">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mb-8">
            ...
            <strong className="text-white">vehicle transport</strong> across
            Nepal — captured in photos &amp; videos.
          </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
                Every photo tells a story of trust, care, and professionalism.
                Browse through our work across Nepal.
              </p>
            </div>
                ...
                {filteredImages.map((img, idx) => {
                  ...
                  if (isMiddleColumn) {
                    if (row === middleRow) {
                      ...
                      alignmentClass =
                        row % 2 === 0 ? "-translate-y-8" : "translate-y-8";
                    }
                  }
                  ...
                  return (
                    <div
                      key={idx}
                      className={`transition-transform duration-500 ${alignmentClass}`}
                    >
                      <button
        ...
        <section className="py-16 md:py-24 px-6 bg-gradient-to-b from-white via-orange-50/30 to-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
                Real videos of our team handling packing, loading, shifting, and
        ...
        <div className="max-w-7xl mx-auto relative z-10 px-6">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-white/50 max-w-2xl mx-auto">
              See what goes on behind every successful move — from careful
              packing to safe delivery.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Every item wrapped with bubble wrap, foam, and corrugated boxes.",
                },
                {
                  icon: <FaTruck />,
                  title: "GPS-Tracked Fleet",
                  desc: "Track your belongings in real-time across Nepal.",
                },
                {
                  icon: <FaShieldAlt />,
                  title: "Zero-Damage Guarantee",
                  desc: "Professional handling ensures your items arrive safe.",
                },
                {
                  icon: <FaClock />,
                  title: "On-Time Delivery",
                  desc: "We arrive on time, load Sajilo, and deliver on schedule.",
                },
              ].map((item) => (
                <div
                  key={item.title}
                  className="flex items-start gap-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 hover:bg-white/10 hover:border-white/20 transition-all duration-300 group"
                >
                  <span className="text-3xl flex-shrink-0 text-orange-400">
                    {item.icon}
                  </span>
                  <div>
      ...
      <section className="py-20 md:py-28 px-6 bg-gradient-to-b from-orange-50 via-red-50/50 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Scroll through our proudest moments — real moves, real customers,
              real satisfaction.
            </p>
          </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                  ...
                  <p className="text-white text-sm">
                    {currentItems[lightboxIndex]?.alt}
                  </p>
                </div>
              </div>
            ) : (
