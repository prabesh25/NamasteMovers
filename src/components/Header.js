...
//       ([entry]) => {
//         // Toggle transparent styling while the hero section is visible
...
//       : "bg-white/95 border-slate-200 text-slate-900 shadow-lg backdrop-blur"
//   }`;
//   const linkClasses = `transition-colors ${
//     isTransparent ? "text-white hover:text-white/70" : "text-slate-700 hover:text-brand-700"
//   }`;
//   const brandClasses = `font-bold text-2xl transition-colors ${
//     isTransparent ? "text-white" : "text-brand-700"
//   }`;
//   const iconBarClasses = `block w-6 h-0.5 transition-colors ${
//     isTransparent ? "bg-white" : "bg-slate-800"
//   }`;
...
//             className={`btn-primary transition-opacity ${isTransparent ? "opacity-90" : "opacity-100"}`}
//           >
...
//                 className={isTransparent ? "hover:text-white/70" : "hover:text-brand-700"}
//               >
//                 {item.label}
//               </Link>
//             ))}
//             <Link href="tel:+9779851226669" className="btn-primary w-full text-center">
//               Call 24/7: +977 9851226669
//             </Link>
//           </div>
//         </div>
