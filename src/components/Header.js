...
const nav = [
  { href: "/", label: "HOME" },
  {
    ...
    label: "SERVICES",
    dropdown: [
      { href: "/services#residential-shifting", label: "Residential Moving" },
      { href: "/services#office-shifting", label: "Office/Corporate" },
      { href: "/services#vehicle-bike-transport", label: "Vehicle & Bike Transport" },
      { href: "/services#packing-boxing", label: "Packing & Boxing" },
    ],
  },
